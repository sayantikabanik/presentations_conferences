...
- Interview with Eclipse Foundation 2026: [Open Source + Founding DataJourneyHQ](https://opensourceglobalvoices.org/how-sayantika-turned-wanderlust-into-open-source-innovation/)
...
- Speaker: StackConf 2022 Berlin, Data pipelines powered by Open source and fun 
- Speaker: PyCon India 2021, Visualisation & Underlined Psychology (Case Study included)
- Keynote Speaker: Devconf 2019 by @RedHat and Developer Weekend 2019
- Speaker: Blr Team at @Twilio, AWS Basics
- Speaker: CCDays Online by KonfHub, Intro to Django Debugging and Building Insights
- Speaker: Workshop @PyLadies Bangalore, Django Unchained
- Speaker: Workshop @Infosec Girls Bangalore Chapter & WTM Bangalore, Python the fun way
- Speaker: Workshop conducted by @GirlScript Foundation Bangalore, Hands-on with GIT and Decoding open source
